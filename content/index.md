...
Saya adalah **T-Shaped Software Engineer** dengan deep expertise di **Modern Web Development (TypeScript & Ekosistem JS)** dan broad understanding di **Software Architecture, Cloud-Native, dan DevOps**. Saat ini, saya memimpin **Sankuriang Labs**—sebuah agensi yang fokus pada pembangunan solusi scalable dan performance-driven. Filosofi saya adalah membangun sistem yang tidak hanya berfungsi, tetapi juga **maintainable, secure, dan cost-effective** melalui adopsi praktik terbaik seperti **Infrastructure as Code (IaC)** dan **CI/CD** yang solid.
